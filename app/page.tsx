      ...
      <section className="py-20 px-4 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <p>
              I bring a modern, tech-savvy approach to real estate, combining local knowledge with smart digital marketing that helps you stand out in a busy market. My goal is to keep the process clear, simple, and focused on what matters most: your needs.
            </p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-4 bg-harcourts-lightGray rounded-lg text-center border border-gray-100">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2">
          <div className="p-12 bg-harcourts-blue text-white">
            ...
            <p className="mb-8 opacity-80">
              Whether you are looking to buy, sell, or just want a professional appraisal of your home, I'm here to help you make a confident decision.
            </p>
